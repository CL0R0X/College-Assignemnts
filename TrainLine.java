...
public class TrainLine {
    ...
    /*
    This method when called upon deleted two train lines
    */
    public void deleteDelete(String name) {
        TrainStation nextStation = new TrainStation(name);
        TrainStation next = nextStation.getNext();
        String next1 = next.toString();
        if (next.hasNext()){
            delete(name);
            delete(next1);
        }
    ...
    public String toString() {
        ...
        if (this.head == null) {
            ...
            TrainStation current = this.head;
            // Get the name of ever station and add it to the StringBuilder object.
            while (current.hasNext()) {
